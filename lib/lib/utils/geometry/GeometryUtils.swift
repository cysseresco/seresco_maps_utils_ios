...
class GeometryUtils: NSObject {
    ...
    public var lastDelegate: GMSMapViewDelegate?
    ...
    public func finishDrawingOfPolygon() {
        print("hey finish")
        googleMap.delegate = lastDelegate
    }
    
    public func startDrawingOfPolygon() {
        lastDelegate = googleMap.delegate
